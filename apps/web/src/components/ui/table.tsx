...
const Table: Component<ComponentProps<'table'> & { container?: ComponentProps<'div'> }> = (
  props,
) => {
  const [local, others] = splitProps(props, ['class', 'container']);
  return (
    <div {...local.container} class={cn('relative w-full overflow-auto', local.container?.class)}>
